...
def give_synsets_from_indices(indices, path_to_yaml="data/imagenet_idx_to_synset.yaml"):
    ...
    print("Using {} different synsets for construction of Restriced Imagenet100.".format(len(synsets)))
    return synsets
...
class ImageNetTrain(ImageNetBase):
    ...
    def _prepare(self):
        self.random_crop = retrieve(self.config, "ImageNetTrain/random_crop",
                                    default=True)
        self.root = os.path.join('/data/netmit/rf-diary2/dataset/ImageNet-100-LT', "{}_info".format(self.NAME))
        self.datadir = os.path.join('/data/netmit/rf-diary2/dataset/ImageNet-100-LT', self.NAME)
