...
class ImageNetTrain(ImageNetBase):
    ...
    def _prepare(self):
        self.random_crop = retrieve(self.config, "ImageNetTrain/random_crop",
                                    default=True)
        self.root = os.path.join('/data/netmit/rf-diary2/dataset/ImageNet-100', "{}_info".format(self.NAME))
        self.datadir = os.path.join('/data/netmit/rf-diary2/dataset/ImageNet-100', self.NAME)
