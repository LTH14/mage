...
class ImageNetTrain(ImageNetBase):
    ...
    def _prepare(self):
        self.random_crop = retrieve(self.config, "ImageNetTrain/random_crop",
                                    default=True)
        self.root = os.path.join('data_info', "{}_info".format(self.NAME))
        # self.datadir = os.path.join('/data/netmit/rf-diary2/dataset/Imagenet', self.NAME)
        self.datadir = os.path.join('/nobackup/projects/public/ImageNet/ILSVRC2012', self.NAME)
        self.txt_filelist = os.path.join('data_info', "{}_info".format(self.NAME), "filelist.txt")
